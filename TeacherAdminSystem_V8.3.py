...
class TeacherStatsApp:
    def __init__(self, root):
        self.root = root
        self.root.title("教師資料管理中心 - 行政綜合業務系統 (V7.4)")
    ...
    def setup_tab3(self, f):
        ...
        manual_frame = ttk.LabelFrame(main, text="手動輸入額外人員數據 (約用、兼任、助教)", padding=10)
        manual_frame.pack(fill=tk.X, pady=10)
        
        self.manual_entries = {} 
        items = [("約用人員", "manual"), ("兼任教師", "pt"), ("新制助教", "new_ta"), ("舊制助教", "old_ta")]
    ...
    def gen_vice_president_report(self):
        ...
        try:
            ...
            display_names = {"manual": "約用人員(填報)", "pt": "兼任教師(填報)", "new_ta": "新制助教(填報)", "old_ta": "舊制助教(填報)"}
